...
var BOOK = [
  { p: 1, t: '马克思主义理论', chapters: [
    ...
    { c: 3, t: '中国特色社会主义理论体系', secs: [
      { n: 1, t: '中国特色社会主义理论体系的形成发展', f: 'p1c3-1.html', pg: '58–59' },
      { n: 2, t: '邓小平理论', f: 'p1c3-2.html', pg: '59–62' },
      { n: 3, t: '"三个代表"重要思想', f: 'p1c3-3.html', pg: '62–65' },
      { n: 4, t: '科学发展观', f: 'p1c3-4.html', pg: '65–66' }
    ]},
    { c: 4, t: '习近平新时代中国特色社会主义思想', secs: [
      { n: 1, t: '是党和国家必须长期坚持的指导思想', f: 'p1c4-1.html', pg: '66–70' },
      { n: 2, t: '主要内容', f: 'p1c4-2.html', pg: '70–73' },
      { n: 3, t: '世界观和方法论', f: 'p1c4-3.html', pg: '73–79' }
    ]}
  ]},
