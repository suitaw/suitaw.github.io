...
var BOOK = [
  { p: 1, t: '马克思主义理论', chapters: [
    ...
    { c: 2, t: '毛泽东思想', secs: [
      ...
      { n: 2, t: '新民主主义革命理论', f: '', pg: '48–54' },
      { n: 3, t: '社会主义改造理论', f: '', pg: '54–56' },
      { n: 4, t: '社会主义革命和建设中取得的独创性理论成果', f: '', pg: '56–58' }
    ]},
...
'.bn-body{overflow-y:auto;-webkit-overflow-scrolling:touch;padding:6px 12px calc(18px + env(safe-area-inset-bottom,0px));}',
...
'.bn-c>summary{list-style:none;cursor:pointer;padding:11px 13px;display:flex;align-items:center;gap:9px;min-height:44px;}',
...
'.bn-s{display:flex;align-items:center;gap:9px;padding:10px 13px;min-height:44px;',
...
'.bn-s .st{flex:1;min-width:0;font-size:.84rem;line-height:1.4;}',
