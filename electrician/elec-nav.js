...
{part:'基础篇', chs:[
  ...
  {n:2, t:'常用电器和电子元器件', p:20, d:'开关、接触器、继电器、传感器、变压器、电动机',
   secs:[
     {id:'2.1',  f:'c2-1.html', t:'低压开关',   d:'闸刀、铁壳开关、组合开关', p:20},
     {id:'2.2',  f:'c2-2.html', t:'接触器',     d:'用小电流控大电流，失压保护', p:22},
     {id:'2.3',  f:'c2-3.html', t:'继电器',     d:'热继电器、时间继电器等八种', p:25},
     {id:'2.4',  f:'c2-4.html', t:'传感器',     d:'温度、湿度、光电、气敏', p:28},
     {id:'2.5a', f:'c2-5a.html',t:'电子元器件（上）', d:'电阻器、电容器、电感器', p:30},
     {id:'2.5b', f:'c2-5b.html',t:'电子元器件（下）', d:'二极管、晶体管、场效应管、晶闸管', p:37},
     {id:'2.6',  f:'c2-6.html', t:'变压器',     d:'单相变压器、三相变压器', p:42},
     {id:'2.7',  f:'c2-7.html', t:'电动机',     d:'直流电动机、交流电动机', p:44}
   ]},
  {n:3, t:'常用工具和仪表的功能与使用', p:48, d:'验电器、万用表、钳形表、绝缘电阻表',
   /* 书上 3.1~3.4 是钳子/螺钉旋具/电工刀/扳手，四节合成一节 3.1。
      **2026-09-03 修正**：原来整个跳过，理由是「手上的劲网页教不了」——
      那个判断漏了里面纯知识的那一层。题库 7-C 组那五道题
      （钢丝钳四个部位／钳柄耐压 500V／手柄不能敲／尖嘴钳 150mm 是总长／
      剥线钳刃口比线径稍大）**没有一道考手法**。
      手上的活（推削、压接、力道）仍然不教，剥线的尺寸和判据在第 6 章。 */
   secs:[
     {id:'3.1',  f:'c3-1.html', t:'手上的工具', d:'哪把干哪个活、哪个部位干什么', p:48},
     {id:'3.5',  f:'c3-5.html', t:'验电器',       d:'验电笔为什么会亮，不亮≠没电', p:56},
     {id:'3.6a', f:'c3-6a.html', t:'万用表（上）', d:'认表、测电压、测电流', p:58},
     {id:'3.6b', f:'c3-6b.html', t:'万用表（下）', d:'测电阻、通断、指针表、查故障', p:59},
     {id:'3.7',  f:'c3-7.html', t:'钳形表',       d:'不断线测电流', p:61},
     {id:'3.8',  f:'c3-8.html', t:'绝缘电阻表',   d:'兆欧表，测绝缘', p:61}
   ]},
  /* 第 4 章按「能看懂一张真图」排，不按书上的条目排。
     就业优先级里它排第二（仅次于安全）—— 上班拿到手的就是原理图。
     **各节的 p 是按 P64~P78 估的，做每节时按 PDF 核对**（书内页 + 14 = PDF 页）。 */
  {n:4, t:'电工识图', p:64, d:'文字符号、图形符号、识图步骤',
   secs:[
     {id:'4.1', f:'c4-1.html', t:'图有哪几种', d:'四种图各回答一个问题', p:75},
     {id:'4.2', f:'c4-2.html', t:'文字符号', d:'字母是什么东西，数字是第几个', p:64},
     {id:'4.3', f:'c4-3.html', t:'图形符号', d:'触点三兄弟：动合·动断·转换', p:69},
     {id:'4.4', f:'c4-4.html', t:'读一张原理图', d:'分主/控两块，顺着电流走一遍', p:74},
     {id:'4.5', f:'c4-5.html', t:'原理图↔接线图', d:'图上拆开画的，实物是同一个', p:76}
   ]}
]},
{part:'实操篇', chs:[
  {n:5,  t:'电气部件与电子元器件的检测', p:79,  d:'开关、断路器、漏电保护器、接触器、电动机的检测',
   secs:[
     {id:'5.2', f:'c5-2.html', t:'保护器件的检测', d:'断路器、漏电保护器、熔断器', p:80},
     {id:'5.3', f:'c5-3.html', t:'接触器与继电器', d:'先认端子，再量线圈和触点', p:83},
     {id:'5.4', f:'c5-4.html', t:'传感器的检测', d:'改变条件，看阻值动不动', p:85},
     {id:'5.5', f:'c5-5.html', t:'变压器的检测', d:'绝缘、绕组、输入输出电压', p:87},
     {id:'5.6', f:'c5-6.html', t:'电动机的检测', d:'绕组、绝缘、空载电流、转速', p:90},
     {id:'5.7', f:'c5-7.html', t:'电子元器件的检测', d:'电阻电容电感、二极管、晶体管', p:95}
   ]},
  {n:6,  t:'线路的加工与连接', p:101, d:'剥线、缠绕、并头、焊接、绝缘恢复',
   secs:[
     {id:'6.1', f:'c6-1.html', t:'剥线加工', d:'按截面积选工具，别伤线芯', p:101},
     {id:'6.2', f:'c6-2.html', t:'线缆的连接', d:'对接、T形、并头，圈数和长度', p:105},
     {id:'6.3', f:'c6-3.html', t:'连接头的加工', d:'接线环做多大才算合格', p:115},
     {id:'6.4', f:'c6-4.html', t:'焊接与绝缘恢复', d:'热收缩管、包缠法、220 与 380 的差别', p:118}
   ]},
  ...
  /* 第 8 章按「就业导向」重排（2026-09-03 定）：书上三节，
     但 8.2「设计安装」有一大半是安装流程实物照片（打孔、装绝缘木板、
     挂电能表、拧端子），**网页教不了手上的活**；8.3.1 高压检修整节不做 ——
     低压电工作业证的范围是交流 1 kV 以下，高压隔离开关、高压熔断器
     不是能碰的东西。所以拆成四节，每节答一个现场真会问的问题。 */
  {n:8,  t:'供配电线路的安装与维护', p:139, d:'高低压供配电、配电箱、配电盘',
   secs:[
     {id:'8.1', f:'c8-1.html', t:'电是怎么送到你家的', d:'一条链、三级配电、四种接线', p:139},
     {id:'8.2', f:'c8-2.html', t:'配电箱里都有什么', d:'配电箱与配电盘、N 排 PE 排、电能表接线', p:143},
     {id:'8.3', f:'c8-3.html', t:'选多大的断路器和线', d:'按功率算电流、载流量、需用系数', p:143},
     {id:'8.4', f:'c8-4.html', t:'停电了怎么查', d:'低压检修五步，一级一级往上走', p:158}
   ]},
  /* 第 9 章按「能看懂一张控制图 + 能查一个故障」排（2026-09-03 定）。
     他 2026-08-30 拍板过「**电力拖动是就业核心、要做厚**」，而且跟第 11 章连着。
     书上三节，但 9.2.2／9.2.3（电动机与被拖动设备的安装连接、固定）
     全是吊装、浇混凝土、拧地脚螺栓的实物照片流程 —— **网页教不了手上的活**，
     和第 6 章开头、7.2、8.2 那几条声明是同一条。
     其余全是硬货：六条设计原则、布线工艺五条、故障分析表、三个带实测数据的案例。 */
  {n:9,  t:'电力拖动系统的安装与维护', p:163, d:'交直流电动机控制电路的安装与检修',
   secs:[
     {id:'9.1', f:'c9-1.html', t:'现场那张图多了什么', d:'指示灯、控制回路熔断器、热继电器触点', p:163},
     {id:'9.2', f:'c9-2.html', t:'六条设计原则', d:'书上给的六条，每条一个改前改后', p:167},
     {id:'9.3', f:'c9-3.html', t:'控制箱怎么装怎么接', d:'箱内布置、布线工艺五条、固定高度', p:172},
     {id:'9.4', f:'c9-4.html', t:'故障怎么缩小范围', d:'五步排查 + 四种现象对照表', p:174},
     {id:'9.5', f:'c9-5.html', t:'三个真实案例', d:'不起动 / 过热 / 起动跳闸', p:176}
   ]},
  /* 第 10 章**大半不做**（他 2026-08-30 拍板的）：
     10.1 直流电动机的拆卸、10.2 交流电动机的拆卸 —— 整两节全是实物照片流程
     （拧螺钉、撬端盖、抽转子、取电刷）；10.3.1 里的机座安装（挖基坑、浇混凝土）
     和联轴器安装（千分表对中）也一样。**网页教不了手上的活。**
     留下来的是两块硬知识：**安装方式代号 ＋ 相序判定**（10.3），
     和**日常维护的全部判据**（10.4）—— 后者数字最多、最能直接拿去用。 */
  {n:10, t:'电动机的拆装与维护应用', p:181, d:'拆卸、安装、日常保养与检查',
   secs:[
     {id:'10.1', f:'', t:'拆卸（不做）', d:'10.1、10.2 全是实物照片流程', p:181},
     {id:'10.3', f:'c10-3.html', t:'装一台电动机', d:'安装方式代号、相序、接线', p:186},
     {id:'10.4', f:'c10-4.html', t:'日常保养和定期检查', d:'六个部位的判据、五种检查法', p:191}
   ]}
]},
{part:'进阶篇', chs:[
  {n:11, t:'电动机常用控制电路的特点与应用', p:196, d:'减压起动、制动、正反转、调速、定时',
   /* 书上九节（11.1~11.9），做六节。**11.1、11.2 不做，是读完 P196~P201 之后判的**：
      图 11-3 的结构组成和 9.1 讲的图 9-2 是同一张图（逐个器件讲过）、
      图 11-4 接线图是 4.5 讲的那件事、自锁 4.4 讲过、两个指示灯 9.1 讲过。
      11.2 唯一的新东西是**单相电动机的起动电容 C**，并进 11.6（书上单相正反转
      正是靠改电容和辅助绕组的接法）。**11.8 和 11.9 都是时间继电器的用法，合成一节。**
      节号跟书走（和第 3、5 章同样处理）。 */
   secs:[
     {id:'11.1', f:'', t:'起停控制（不做）', d:'11.1、11.2 与 9.1、4.4、4.5 重复', p:196},
     {id:'11.3', f:'c11-3.html', t:'串电阻减压起动', d:'起动电流为什么要压下来', p:202},
     {id:'11.4', f:'c11-4.html', t:'星三角减压起动', d:'最常用的一种减压起动', p:204},
     {id:'11.5', f:'c11-5.html', t:'反接制动', d:'让它快点停下来', p:207},
     {id:'11.6', f:'c11-6.html', t:'正反转控制', d:'换两相就反转，但必须互锁', p:210},
     {id:'11.7', f:'', t:'双速电动机调速', d:'变极调速：△ 换成 YY', p:212},
     {id:'11.8', f:'', t:'定时起停与间歇循环', d:'时间继电器的两种用法', p:215}
   ]},
