...
{part:'基础篇', chs:[
  ...
  {n:3, t:'常用工具和仪表的功能与使用', p:48, d:'钳子、螺钉旋具、验电器、万用表、钳形表、绝缘电阻表',
   secs:[
     {id:'3.1', f:'c3-1.html', t:'手动工具',   d:'钳子、螺钉旋具、电工刀、扳手', p:48},
     {id:'3.2', f:'',          t:'验电器',     d:'低压验电笔、高压验电器', p:56},
     {id:'3.3', f:'',          t:'万用表（上）', d:'认表、测电压、测电流', p:58},
     {id:'3.4', f:'',          t:'万用表（下）', d:'测电阻、通断、指针表、查故障', p:59},
     {id:'3.5', f:'',          t:'钳形表',     d:'不断线测电流', p:61},
     {id:'3.6', f:'',          t:'绝缘电阻表', d:'兆欧表，测绝缘', p:61}
   ]},
